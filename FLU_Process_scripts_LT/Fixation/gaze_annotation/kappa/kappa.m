function varargout = kappa(varargin)
...
elseif nu>4
    error('Warning: Max 4 input data are required')
end
default.values = {[],0,0.05,1};
default.values(1:nu) = args;
[x w alpha,verbose] = deal(default.values{:});
...
%output
out = [];
out.observedAgreement = po;
out.expectedAgreement = pe;
out.concordanceAgreement = po-pe;
out.residualAgreement = 1-pe;
out.kappa = k;
out.kappse = sek;
out.kappci = ci;
out.kappamax = km;
