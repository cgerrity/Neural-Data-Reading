function pythonUDPRecvData = ParsePythonUDPRecv_FLU(folder, filestring, scriptPath, varargin)
...
pythonUDPRecvData = table(cmdType, cmd, frameRecv, recvTime, 'variablenames', {'CmdType', 'CMD', 'FrameRecv', 'RecvTime'});
