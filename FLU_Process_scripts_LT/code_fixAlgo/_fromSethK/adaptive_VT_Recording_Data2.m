function [fixationtimes,saccadetimes] = adaptive_VT_Recording_Data2(eyedat)
%re-written for looking at recording data since wasn't handling NaNs wells
...
%---Filter Data and Calculate Velocity/Acceleration of Eye---%
...
oldPeak  = inf;
peakDetectionThreshold = max(vel/4);
