function RemovalPlotTable = cgg_procFullImportanceAnalysis(cfg_Encoder,cfg_Epoch,cfg,varargin)
...
ThresholdTable = cgg_getRandomChanceThreshold(cfg_Epoch,Folds,cfg_Encoder,'SessionName',SessionName,varargin{:});
%%
...
AnalysisDir = fullfile(cfg_Epoch.Results,'Analysis','Importance Analysis','Channel');
...
cgg_saveRemovalTable(RemovalTable,Folds,cfg_Epoch.Results,'Channel',SessionName,SaveTerm);
...
[IA_Table_Fold_Part3,~] = cgg_procRandomImportanceAnalysis(cfg_Encoder,cfg_Epoch,'MatchType',MatchType, ...
...
[IA_Table_Fold_Part4,~] = cgg_procSequentialImportanceAnalysis(cfg_Encoder,cfg_Epoch,'MatchType',MatchType, ...
    'NumRemoved',NumRemovedChannel, ...
    'NumEntries',NumEntries, ...
    'maxworkerMiniBatchSize',maxworkerMiniBatchSize, ...
    'DataFormat',DataFormat,'IsQuaddle',IsQuaddle, ...
