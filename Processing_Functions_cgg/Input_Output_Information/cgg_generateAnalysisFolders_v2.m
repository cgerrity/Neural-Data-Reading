...
% Make the Analysis Type Sub Field folder name
cfg_tmp=cfg.EpochDir.Analysis.AnalysisType.AnalysisTypeSubField.Session;
[cfg_tmp,~] = cgg_generateFolderAndPath(AnalysisTypeSubSubField,'AnalysisTypeSubSubField',cfg_tmp);
cfg.EpochDir.Analysis.AnalysisType.AnalysisTypeSubField.Session=cfg_tmp;

if ~isempty(Fold)
% Make the Fold folder name
FoldName = sprintf('Fold %d',Fold);
cfg_tmp=cfg.EpochDir.Analysis.AnalysisType.AnalysisTypeSubField.Session.AnalysisTypeSubSubField;
[cfg_tmp,~] = cgg_generateFolderAndPath(FoldName,'Fold',cfg_tmp);
cfg.EpochDir.Analysis.AnalysisType.AnalysisTypeSubField.Session.AnalysisTypeSubSubField=cfg_tmp;
...
% Make the Fold folder name
FoldName = sprintf('Fold %d',Fold);
cfg_tmp=cfg.EpochDir.Analysis.AnalysisType.Session;
[cfg_tmp,~] = cgg_generateFolderAndPath(FoldName,'Fold',cfg_tmp);
cfg.EpochDir.Analysis.AnalysisType.Session=cfg_tmp;
