function [CM_Table] = cgg_procTestingResultsNetwork(InDatastore,Mdl,varargin)
...
if isempty(ClassNames)
[ClassNames,NumClasses,ClassPercent,ClassCounts] = cgg_getClassesFromDataStore(InDatastore);
end
%%
...
if wantSave
    SaveVariables={CM_Table};
    SaveVariablesName={'CM_Table'};
