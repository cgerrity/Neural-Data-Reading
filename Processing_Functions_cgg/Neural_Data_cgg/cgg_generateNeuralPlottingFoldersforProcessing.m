function [cfg] = cgg_generateNeuralPlottingFoldersforProcessing(outdatadir,...
    SessionName,ExperimentName,probe_area,Activity_Type,varargin)
...
[cfg_tmp,~] = cgg_generateFolderAndPath('Correlation','Correlation',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity=cfg_tmp;

% Processing Steps
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity;
[cfg_tmp,~] = cgg_generateFolderAndPath('Processing_Steps','Processing_Steps',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity=cfg_tmp;
...
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps;
[cfg_tmp,~] = cgg_generateFolderAndPath('Bandpass','Bandpass',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps=cfg_tmp;

% Processing Steps: Rectify
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps;
[cfg_tmp,~] = cgg_generateFolderAndPath('Rectify','Rectify',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps=cfg_tmp;

% Processing Steps: Lowpass
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps;
[cfg_tmp,~] = cgg_generateFolderAndPath('Lowpass','Lowpass',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps=cfg_tmp;

% Processing Steps: Resample
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps;
[cfg_tmp,~] = cgg_generateFolderAndPath('Resample','Resample',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps=cfg_tmp;

% Processing Steps: Average
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps;
[cfg_tmp,~] = cgg_generateFolderAndPath('Average','Average',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps=cfg_tmp;
...
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps;
[cfg_tmp,~] = cgg_generateFolderAndPath('Notch','Notch',cfg_tmp,'WantDirectory',WantDirectory);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Processing_Steps=cfg_tmp;
