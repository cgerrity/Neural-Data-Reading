...
[cfg_tmp,~] = cgg_generateFolderAndPath(Alignment_Type,'Alignment',cfg_tmp);
...
[cfg_tmp,~] = cgg_generateFolderAndPath('Correct_vs_Error','Correct_vs_Error',cfg_tmp);
...
cfg_tmp=cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Alignment;
cfg_tmp = cgg_generateFolderAndPath('Chosen_Feature','Chosen_Feature',cfg_tmp);
cfg.outdatadir.Experiment.Session.Plots.Area.Activity.Alignment=cfg_tmp;
