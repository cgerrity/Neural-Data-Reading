function cgg_plotDataProcessingSteps(InData,InData_Time,X_Name,Y_Name,InData_Title,InYLim,Smooth_Factor,InSavePlotCFG,InSaveName,varargin)
...
p_Data=plot(InData_Time,this_Data,'LineWidth',4);
