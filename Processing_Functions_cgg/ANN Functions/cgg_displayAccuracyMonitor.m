function cgg_displayAccuracyMonitor(monitor,CM_Table_Training,CM_Table_Validation,ClassNames,MatchType,IsQuaddle,varargin)
%CGG_DISPLAYRECONSTRUCTIONMONITOR Summary of this function goes here
%   Detailed explanation goes here


[~,Accuracy,~] = cgg_procConfusionMatrixWindowsFromTable(CM_Table_Training,ClassNames,'MatchType',MatchType,'IsQuaddle',IsQuaddle,varargin{:});
