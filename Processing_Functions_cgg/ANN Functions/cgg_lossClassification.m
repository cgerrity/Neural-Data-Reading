function [Loss, Loss_TotalConfidence, Loss_TrialConfidence, Loss_TaskConfidence] = cgg_lossClassification(T, Y, options)
%CGG_LOSSCLASSIFICATION Calculates classification loss with optional confidence interpolation.
...
[Y, Loss_TotalConfidence, Loss_TrialConfidence, Loss_TaskConfidence] = ...
    cgg_lossConfidence(Y, T, options.TrialConfidence, options.TaskConfidence, ...
        ...
        'WantBatchCorrection',options.WantBatchCorrection);
