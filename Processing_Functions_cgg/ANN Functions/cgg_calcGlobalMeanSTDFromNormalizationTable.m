function [MeanData,STDData] = cgg_calcGlobalMeanSTDFromNormalizationTable(NormalizationTable,NumSamples)
%CGG_CALCGLOBALMEANSTDFROMNORMALIZATIONTABLE Summary of this function goes here
