function cgg_plotPaperFigureModelProportion(PlotData,varargin)
%CGG_PLOTPAPERFIGUREMODELPROPORTION Summary of this function goes here
...
Y_Tick_Size = cfg_Paper.Tick_Size_ChannelProportion_Model;
...
Plot_Series = PlotData.ProportionModel;
if WantCI
PlotError = PlotData.Model_CI;
else
PlotError = PlotData.Model_STE;
end
...
if ~isempty(PlotPath)
    ...
    PlotName=sprintf('Proportion-Model%s',AreaName);
    end
