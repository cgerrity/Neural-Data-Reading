...
for fidx = 1:NumFolders
    ...
    if isfile(this_PathNameExt)
        ...
        this_TestingStratified = m_Optimal_Results.TestingStratified;
        ...
        this_ValidationStratified = m_Optimal_Results.ValidationStratified;
    ...
    EncodingParameters.ValidationStratified = this_ValidationStratified;
    ...
    EncodingParameters.TestingStratified = this_TestingStratified;
