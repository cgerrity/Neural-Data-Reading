function cgg_plotLabelClassWindowedAccuracy(FullTable,cfg,varargin)
%CGG_PLOTLABELCLASSWINDOWEDACCURACY Summary of this function goes here
...
% NanIDX = cellfun(@(x) all(isnan(x)),ClassTable.Accuracy,'UniformOutput',true);
% ClassTable(NanIDX,:) = [];
