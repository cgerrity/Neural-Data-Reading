function cgg_plotCoefficientValuesRegression_v2(InputTable,SignificanceValue,AreaName,Plotcfg,varargin)
...
PlotNameExt=sprintf('Combined_Coefficient_Values_%s.fig',AreaName);
