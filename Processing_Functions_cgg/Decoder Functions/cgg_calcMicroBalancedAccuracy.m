function [MicroBalancedAccuracy] = cgg_calcMicroBalancedAccuracy(TrueValue,Prediction,ClassNames,varargin)
...
MicroBalancedAccuracy=LabelMetrics.MicroBalancedAccuracy;
end
